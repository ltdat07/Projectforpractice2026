...
Авторизация пользователей пока не реализована. Backend предназначен для локальной учебной демонстрации и не должен публиковаться в открытом интернете без дополнительной защиты.
