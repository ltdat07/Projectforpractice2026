...
Backend пока не содержит авторизацию. Не публикуйте его напрямую в интернет.
Для учебной демонстрации запускайте его локально или в закрытой тестовой сети.
